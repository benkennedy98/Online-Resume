    ...
    <div className="page-container">
      ...
      <div className="body-container">
        <div className="body">
          ...
          see before you. The fist being React, this project started out as a simple create react
          app that I have been working on in my free time to keep my skills fresh and sharp. I am
          using Typescript as it is a simple tool that helps prevent bugs and keeps project
